...
public class SlideDTO {
    ...
    /**
     * DTO para una entrada del log de sincronización.
     */
    @Data
    @Builder
    @NoArgsConstructor
    ...
    public static class SyncLogEntry {
        ...
        private Integer channelId;
        private String channelName;
        private java.time.LocalDateTime odooWriteDate;
        private Long originalSizeBytes;
        private Long processedSizeBytes;
        private Integer imagesExtracted;
        private String message;
    ...
    /**
     * DTO para resumen de una ejecución de sync.
     */
    @Data
    @Builder
    @NoArgsConstructor
    ...
    public static class SyncRunSummary {
        ...
        private java.time.LocalDateTime lastEventAt;
